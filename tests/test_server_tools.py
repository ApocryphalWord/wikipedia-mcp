...
class TestMCPServerTools:
    ...
    def test_create_server_with_language(self, MockWikipediaClient):
        ...
        MockWikipediaClient.assert_called_once_with(language="ja", country=None, enable_cache=False, access_token=None, user_agent=None)
    ...
    def test_create_server_default_language(self, MockWikipediaClient):
        ...
        create_server()
        MockWikipediaClient.assert_called_once_with(language="en", country=None, enable_cache=False, access_token=None, user_agent=None)
    ...
    def test_create_server_with_cache_enabled(self, MockWikipediaClient):
        ...
        MockWikipediaClient.assert_called_once_with(language="en", country=None, enable_cache=True, access_token=None, user_agent=None)
